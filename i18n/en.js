module.exports = {
  ...
  refund: {
    ...
    myRefund: 'My After-sales',
    selectGoods: 'Select goods for after-sales',
    goodsInfo: 'Goods Info',
    refundType: 'Service Type',
    refundReason: 'Reason',
    refundRemark: 'Description',
    refundRemarkPlaceholder: 'Please describe your problem in detail',
    refundRemarkOptional: '(Optional)',
    uploadProof: 'Upload Proof',
    uploadProofOptional: '(Optional, up to 9 images)',
    refundNumber: 'Quantity',
    submitBtn: 'Submit',
    notSupport: 'This product does not support after-sales',
    type0: 'Refund Only',
    type1: 'Return & Refund',
    type2: 'Exchange',
    logisticsStatus: 'Logistics Status',
    logisticsStatus0: 'Not Received',
    logisticsStatus1: 'Received',
    reasons: [
      'Don\'t like/Don\'t want',
      'Empty package',
      'Not shipped on time',
      'Logistics not delivered',
    ...
    backAddressName: 'Recipient',
    backAddressPhone: 'Phone',
    backAddressDetail: 'Address',
    fillLogistics: 'Fill in tracking number',
    logisticsCompany: 'Courier Company',
    logisticsNumber: 'Tracking Number',
    logisticsCompanyPlaceholder: 'Enter courier company',
    logisticsNumberPlaceholder: 'Enter tracking number',
    logisticsFilled: 'Tracking info filled',
    logisticsTip: 'Please fill in the tracking information',
    submitLogistics: 'Submit',
    ...
    applyingTip: 'This product is already in after-sales process',
  },
  cashLog: {
    title: 'Fund details',
  },
